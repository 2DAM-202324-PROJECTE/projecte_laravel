    ...
    <div class="">
        ...
        <div id="documentalsContainer" class="sm:flex sm:flex-wrap justify-center gap-4 mx-20 mb-4">
            @foreach($documentals as $index => $documental)
                <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 m-2 md:flex-wrap mb-4 documental"> <!-- Ajusta el ancho de cada película aquí -->
                    <div>
        ...
        <div class="flex justify-center mt-4 pb-32"> <!-- Contenedor flex para centrar el botón -->
            <button id="loadMoreDocumentals" class="bg-white py-2 px-4 text-sm tracking-wide rounded-lg text-white" style="background: #39A9FE;">Cargar més</button>
        </div>
