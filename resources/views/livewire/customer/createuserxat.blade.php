    ...
    <div class="container mx-auto py-20">
        ...
        <div style="background: #553d2a" class="editor mx-auto w-10/12 flex flex-col border-gray-900 rounded-md border-4
         ...
         text-gray-800 bg-gray-50 p-4 max-w-2xl mt-20">
            ...
            <form id="createForm" wire:submit.prevent="create" class="space-y-4">
                ...
                <div class="flex items-center justify-center md:gap-8 gap-4 pt-5 pb-5">
                    <!-- botó de crear -->
                    <button type="button" onclick="validateAndSubmit(true)" class="text-2xl justify-center rounded-md border border-transparent shadow-sm px-8 py-2 bg-green-700
                    ...
                    <!-- botó de cancel·lar -->
                    <button type="button" onclick="cancel()" class="text-2xl justify-center rounded-md border border-transparent shadow-sm px-8 py-2 bg-red-800
...
<script>
    function validateAndSubmit(isGreenButton) {
        if (isGreenButton) {
