        ...
        <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 bg-gray-50 p-4 shadow-lg max-w-2xl mt-20">
            ...
            <form wire:submit.prevent="{{ $isCreation ? 'save' : 'update' }}" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="path" wire:model="path" class="text-gray-700 text-sm font-bold description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none w-full" spellcheck="false" placeholder="Localització de la media..."></textarea>
                </div>
                <div>
                    <label for="category" class="text-gray-700 text-sm font-bold block mb-2">Category:</label>
                    <select id="category" wire:model="category_id" class="text-gray-700 text-sm font-bold rounded-md title bg-gray-100 border border-gray-300 p-2 outline-none w-full mb-4">
